...
class MyWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.show()
        # Load event items
        self.Database_1 = Database.Server_1('192.168.1.7')
        ...
        self.button_customer.clicked.connect(self.showConfigCustomer)
        self.button_employer.clicked.connect(self.showConfigEmployee)
        self.button_item.clicked.connect(self.showConfigItem)
        self.button_invoice.clicked.connect(self.showConfigInvoice)
        # Load Camera
