...
class MyWindow(QtWidgets.QDialog):
    ...
    def __init__(self):
        ...
        # Load button event
        self.Database_1 = Database.Server_1('192.168.1.5')
    ...
    def insert(self):
        ...
        if CMTND == '' or customerName == '':
            QtWidgets.QMessageBox.critical(None, 'Lỗi', 'Không đủ giá trị nhập (*)')
            return
